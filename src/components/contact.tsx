    ...
    <section id="contact" className="my-20 min-h-96 w-screen px-10">
      <div className="relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center">
          <p className="font-general text-[10px] uppercase">Join PSGMX Forks</p>

          <p className="special-font font-zentry mt-10 w-full text-5xl leading-[0.9] md:text-[6rem]">
            Let&apos;s b<b>u</b>ild the
            <br /> open s<b>o</b>urce <br /> w<b>o</b>rld together
          </p>

          <Button containerClass="mt-10 cursor-pointer">Get In Touch</Button>
        </div>
      </div>
    </section>
  );
